...
function rollover(elem,state)
{
    try
    {
        if(document.images)
        {
            ...
            //homepage
            var home_head1_off      = new Image();
            var home_head2_off      = new Image();
            var home_head3_off      = new Image();
            var home_head4_off      = new Image();
            var home_head1_on       = new Image();
            var home_head2_on       = new Image();
            var home_head3_on       = new Image();
            var home_head4_on       = new Image();
            ...
            //homepage
            home_head1_off.src      = base + "link1.jpg";
            home_head2_off.src      = base + "link2.jpg";
            home_head3_off.src      = base + "link3.jpg";
            home_head4_off.src      = base + "link4.jpg";
            home_head1_on.src       = base + "link1_on.jpg";
            home_head2_on.src       = base + "link2_on.jpg";
            home_head3_on.src       = base + "link3_on.jpg";
            home_head4_on.src       = base + "link4_on.jpg";
            ...
            //and homepage:
            imgs["link1"] = {on:home_head1_on,   off:home_head1_off};
            imgs["link2"] = {on:home_head2_on,   off:home_head2_off};
            imgs["link3"] = {on:home_head3_on,   off:home_head3_off};
            imgs["link4"] = {on:home_head4_on,   off:home_head4_off};
